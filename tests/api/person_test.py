...
class PersonApiTestCase(FlampleApiTestCase):
    ...
    def test_create_persons(self):
        r = self.jpost(
            ...
            data={
                ...
                "emails-0-name": "user_new@flample.com",
    ...
    def test_create_invalid_person(self):
        r = self.jpost("/persons", data={"first_name": "New Person"})
        self.assertBadJson(r)

    def test_update_person(self):
        r = self.jpost(
            "/persons/%s/update" % self.person.id, data={"name": "New Person"}
        )
        self.assertOkJson(r)
