...
class Person(PersonJsonSerializer, db.Model):
    ...
    emails = db.relationship("Email", backref=db.backref("persons"))

    addresses = db.relationship("Address", backref=db.backref("persons"))

    phones = db.relationship("Phone", backref=db.backref("persons"))
